        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 table-responsive">
                    ...
                    <x-secondary-button>
                        <a href="{{ route('apartamentos.create') }}">Añadir nuevo Apartamento</a>
                    </x-secondary-button>

                    <table class="table table-hover table-bordered table-striped align-middle text-center shadow-sm mt-4">
                        <thead class="t">
                            <tr>
                                <th>ID</th>
                                <th>Dirección</th>
